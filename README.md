...
app/
  ...
  webapp/static/_vendored/  vendor-verbatim web-app UI components (nav/, icons/, card/, disclosure/, modal/, empty-state/, switch/, icon-tile/, button/, range-tab/, page-foot/ + demo.html gallery)
src/
