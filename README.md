...
app/
  ...
  webapp/static/_vendored/  vendor-verbatim web-app UI components (nav/, icons/, card/, disclosure/, modal/, empty-state/, switch/, icon-tile/ + demo.html gallery)
src/
