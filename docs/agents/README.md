...
- **`project-skills.md`** — the portable project/nested skill layout, single-source and scoped-link contract, privacy/ignore rules, native capability evidence and clone/worktree verification.
